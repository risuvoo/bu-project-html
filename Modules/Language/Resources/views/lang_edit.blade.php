      ...
      <div class="main-content">
        <section class="section">
          ...
          <div class="section-body">
            <a href="{{ route('admin.language.index') }}" class="btn btn-primary"><i class="fas fa-list"></i> {{__('admin.Languages')}}</a>
            <div class="row mt-4">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.language.update', $language->id) }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <input class="form-control" type="text" name="lang_code" value="{{ $language->lang_code }}" readonly>
                                </div>
                                <div class="form-group col-12">
