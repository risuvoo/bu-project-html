...
@section('title')
<title>{{__('admin.Theme language')}}</title>
@endsection
                ...
                <div class="card-body">
                  ...
                  <div class="lang_list_top">
                      <ul class="lang_list">
                          ...
                          <li><a href="{{ route('admin.theme-language', ['lang_code' => $language->lang_code] ) }}"><i class="fas fa-edit"></i> {{ $language->lang_name }}</a></li>
                          @endforeach
                      </ul>
                  </div>
