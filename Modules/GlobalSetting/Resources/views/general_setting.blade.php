...
@section('title')
<title>{{__('admin.General Setting')}}</title>
@endsection
...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>{{__('admin.General Setting')}}</h1>
        </div>
                            ...
                            <form action="{{ route('admin.update-general-setting') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="selected_theme" id="" class="form-control">
                                        <option {{ $setting->selected_theme == 'all_theme' ? 'selected' : '' }} value="all_theme">{{__('admin.All Theme')}}</option>
                                        <option {{ $setting->selected_theme == 'theme_one' ? 'selected' : '' }} value="theme_one">{{__('admin.Theme One')}}</option>
                                        <option {{ $setting->selected_theme == 'theme_two' ? 'selected' : '' }} value="theme_two">{{__('admin.Theme Two')}}</option>
                                        <option {{ $setting->selected_theme == 'theme_three' ? 'selected' : '' }} value="theme_three">{{__('admin.Theme Three')}}</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group d-none">
                                    <label for="">{{__('admin.Currency Position')}}</label>
                                    <select name="currency_position" id="" class="form-control">
                                        <option {{ $setting->currency_position == 'before_price' ? 'selected' : '' }} value="before_price">{{__('admin.Before Price')}}</option>
                                        <option {{ $setting->currency_position == 'after_price' ? 'selected' : '' }} value="after_price">{{__('admin.After Price')}}</option>
                                    </select>
                                </div>
