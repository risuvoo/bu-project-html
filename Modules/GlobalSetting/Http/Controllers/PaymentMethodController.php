...
class PaymentMethodController extends Controller
{
    ...
    public function index(){
        ...
        return view('globalsetting::payment_method', compact('paypal','stripe','razorpay','bank','paystackAndMollie','flutterwave','instamojo','countires','currencies','setting','currency_list'));
    }
    ...
    public function updatePaypal(Request $request){
        ...
        $customMessages = [
            ...
            'currency_id.required' => trans('admin_validation.Currency name is required'),
        ];
    ...
    public function updateMollie(Request $request){
        ...
        $customMessages = [
            ...
            'mollie_currency_id.required' => trans('admin_validation.Currency name is required'),
        ];
        $request->validate($rules,$customMessages);
    ...
    public function updatePayStack(Request $request){
        ...
        $customMessages = [
            ...
            'paystack_currency_id.required' => trans('admin_validation.Currency name is required'),
        ];
        $request->validate($rules,$customMessages);
