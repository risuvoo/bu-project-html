      ...
      <div class="main-content">
        <section class="section">
          <div class="section-header">
            <h1>{{__('admin.Edit Service Category')}}</h1>
          </div>
              ...
              <div class="card-body">
                ...
                <div class="lang_list_top">
                    <ul class="lang_list">
                        ...
                        <li><a href="{{ route('admin.service-category.edit', ['service_category' => $category->id, 'lang_code' => $language->lang_code] ) }}"><i class="fas fa-edit"></i> {{ $language->lang_name }}</a></li>
                        @endforeach
                    </ul>
                </div>
                                ...
                                @if (admin_lang() == request()->get('lang_code'))
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <select name="status" class="form-control">
                                            <option {{ $category->status == 'active' ? 'selected' : '' }} value="active">{{__('admin.Active')}}</option>
                                            <option {{ $category->status == 'inactive' ? 'selected' : '' }} value="inactive">{{__('admin.Inactive')}}</option>
                                        </select>
                                    </div>
