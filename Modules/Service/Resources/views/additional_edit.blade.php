      ...
      <div class="main-content">
        <section class="section">
                ...
                <div class="card-body">
                  ...
                  <div class="lang_list_top">
                      <ul class="lang_list">
                          ...
                          <li><a href="{{ route('admin.additional-edit', ['id' => $additional->id, 'lang_code' => $language->lang_code] ) }}"><i class="fas fa-edit"></i> {{ $language->lang_name }}</a></li>
                          @endforeach
                      </ul>
                  </div>
          ...
          <div class="section-body">
            <a href="{{ route('admin.additional-service', $service->id) }}" class="btn btn-primary"><i class="fas fa-backward"></i> {{__('admin.Go Back')}}</a>
            <div class="row mt-4">
                <div class="col">
                  <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.additional-update', $additional->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
