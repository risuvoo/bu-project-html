            ...
            <div class="chat-item chat-left" style="">
                ...
                <div class="chat-details">
                    <div class="wsus__show_product">
                        <div class="img">
                            <img src="{{ asset($message->service->thumbnail_image) }}" alt="user" class="img-fluid w-100">
                        </div>
                        <a target="_blank" href="{{ route('service', $message->service->slug) }}">{{ $message->service->title }}</a>
                    </div>
                    <div class="chat-time">{{ $message->created_at->diffForHumans() }}</div>
                </div>
            </div>
