...
@section('title')
<title>{{__('admin.Send Mail To influencer')}}</title>
@endsection
      ...
      <div class="main-content">
        <section class="section">
          <div class="section-header">
            <h1>{{__('admin.Send Mail To influencer')}}</h1>
                ...
                <div class="col">
                    <div class="card">
                        <div class="card-header">
                            <h1>{{__('admin.Send Email to')}} {{ $influencer->email }}</h1>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('admin.send-mail-to-single-influencer',$influencer->id) }}" method="POST">
                                @csrf
